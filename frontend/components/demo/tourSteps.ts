...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    narration: "Visibility is the market-awareness layer. GrowthOS runs parallel searches for your brand and each competitor at equal depth, so share of voice is a fair comparison — not a number where you get a structural head start. Below the SOV bars you'll see the Competitive Effectiveness panel, which scores each player zero to a hundred across four dimensions: share of voice, sentiment quality, intent quality, and earned-mention ratio. A competitor with fewer mentions but higher-quality conversations will outscore you here, and that is the more dangerous position to be in. The trend chart shows your SOV moving over time so you can see whether you are becoming more visible in the category or just publishing more content. Results are cached for an hour so the page is instant on repeat visits.",
    dwellMs: 8000
  },
  {
    id: "in-the-wild",
